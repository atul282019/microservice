...
import com.gov.nha.bis.upi.ack.types.AadhaarConsentConstant;
 ...
 */
public class PayerType implements java.io.Serializable {
    ...
    /**
     * Field _aadhaarConsent
     */
    private com.gov.nha.bis.upi.ack.types.AadhaarConsentConstant _aadhaarConsent;
     ...
     * Field _newCred
     */
    private com.gov.nha.bis.upi.ack.CredsType _newCred;
     ...
     * Field _regIdDetails
     */
    private com.gov.nha.bis.upi.ack.RegIdDetailsType _regIdDetails;
    ...
    public PayerType() 
     {
        super();
    } //-- com.gov.nha.bis.upi.ack.PayerType()
    ...
    /**
     * Returns the value of field 'aadhaarConsent'.
     * 
     * @return AadhaarConsentConstant
     * @return the value of field 'aadhaarConsent'.
     */
    public com.gov.nha.bis.upi.ack.types.AadhaarConsentConstant getAadhaarConsent()
    {
        return this._aadhaarConsent;
    } //-- com.gov.nha.bis.upi.ack.types.AadhaarConsentConstant getAadhaarConsent() 
    ...
    /**
     * Returns the value of field 'newCred'.
     * 
     * @return CredsType
     * @return the value of field 'newCred'.
     */
    public com.gov.nha.bis.upi.ack.CredsType getNewCred()
    {
        return this._newCred;
    } //-- com.gov.nha.bis.upi.ack.CredsType getNewCred() 

    /**
     * Returns the value of field 'regIdDetails'.
     * 
     * @return RegIdDetailsType
     * @return the value of field 'regIdDetails'.
     */
    public com.gov.nha.bis.upi.ack.RegIdDetailsType getRegIdDetails()
    {
        return this._regIdDetails;
    ...
    /**
     * Sets the value of field 'aadhaarConsent'.
     * 
     * @param aadhaarConsent the value of field 'aadhaarConsent'.
     */
    public void setAadhaarConsent(com.gov.nha.bis.upi.ack.types.AadhaarConsentConstant aadhaarConsent)
    {
        this._aadhaarConsent = aadhaarConsent;
    } //-- void setAadhaarConsent(com.gov.nha.bis.upi.ack.types.AadhaarConsentConstant) 
    ...
    /**
     * Sets the value of field 'newCred'.
     * 
     * @param newCred the value of field 'newCred'.
     */
    public void setNewCred(com.gov.nha.bis.upi.ack.CredsType newCred)
    {
        this._newCred = newCred;
    } //-- void setNewCred(com.gov.nha.bis.upi.ack.CredsType) 

    /**
     * Sets the value of field 'regIdDetails'.
     * 
     * @param regIdDetails the value of field 'regIdDetails'.
     */
    public void setRegIdDetails(com.gov.nha.bis.upi.ack.RegIdDetailsType regIdDetails)
    {
        this._regIdDetails = regIdDetails;
     ...
     * @return Object
     */
    public static java.lang.Object unmarshalPayerType(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.gov.nha.bis.upi.ack.PayerType) Unmarshaller.unmarshal(com.gov.nha.bis.upi.ack.PayerType.class, reader);
    } //-- java.lang.Object unmarshalPayerType(java.io.Reader) 

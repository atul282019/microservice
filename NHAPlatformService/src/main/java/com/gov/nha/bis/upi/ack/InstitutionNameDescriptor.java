...
/**
 * Class InstitutionNameDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class InstitutionNameDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InstitutionNameDescriptor() 
     {
        super();
        nsURI = "http://npci.org/upi/schema/";
        xmlName = "institutionName";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                InstitutionName target = (InstitutionName) object;
    ...
    } //-- com.gov.nha.bis.upi.ack.InstitutionNameDescriptor()
    ...
    {
        return com.gov.nha.bis.upi.ack.InstitutionName.class;

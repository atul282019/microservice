...
/**
 * Class ReqVoucherConfirmationDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ReqVoucherConfirmationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReqVoucherConfirmationDescriptor() 
     {
        super();
        nsURI = "http://npci.org/upi/schema/";
        xmlName = "ReqVoucherConfirmation";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ReqVoucherConfirmation target = (ReqVoucherConfirmation) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _txnConfirmation
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.gov.nha.bis.upi.ack.TxnConfDtl.class, "_txnConfirmation", "TxnConfirmation", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ReqVoucherConfirmation target = (ReqVoucherConfirmation) object;
                return target.getTxnConfirmation();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReqVoucherConfirmation target = (ReqVoucherConfirmation) object;
                    target.setTxnConfirmation( (com.gov.nha.bis.upi.ack.TxnConfDtl) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.gov.nha.bis.upi.ack.TxnConfDtl();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        //-- validation code for: _txnConfirmation
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        ...
        desc.setValidator(fieldValidator);
    } //-- com.gov.nha.bis.upi.ack.ReqVoucherConfirmationDescriptor()
    ...
    {
        return com.gov.nha.bis.upi.ack.ReqVoucherConfirmation.class;

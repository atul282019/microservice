...
/**
 * Class PayerInfoTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PayerInfoTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PayerInfoTypeDescriptor() 
     {
        super();
        nsURI = "http://npci.org/upi/schema/";
        xmlName = "payerInfoType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PayerInfoType target = (PayerInfoType) object;
    ...
    } //-- com.gov.nha.bis.upi.ack.PayerInfoTypeDescriptor()
    ...
    {
        return com.gov.nha.bis.upi.ack.PayerInfoType.class;

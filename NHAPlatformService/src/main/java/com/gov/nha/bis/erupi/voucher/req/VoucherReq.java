 ...
 */
public class VoucherReq implements java.io.Serializable {
     ...
     * Field _voucherData
     */
    private com.gov.nha.bis.erupi.voucher.req.VoucherData _voucherData;
    ...
    public VoucherReq() 
     {
        super();
    } //-- com.gov.nha.bis.erupi.voucher.req.VoucherReq()
    ...
    /**
     * Returns the value of field 'voucherData'.
     * 
     * @return VoucherData
     * @return the value of field 'voucherData'.
     */
    public com.gov.nha.bis.erupi.voucher.req.VoucherData getVoucherData()
    {
        return this._voucherData;
    } //-- com.gov.nha.bis.erupi.voucher.req.VoucherData getVoucherData() 
    ...
    /**
     * Sets the value of field 'voucherData'.
     * 
     * @param voucherData the value of field 'voucherData'.
     */
    public void setVoucherData(com.gov.nha.bis.erupi.voucher.req.VoucherData voucherData)
    {
        this._voucherData = voucherData;
    } //-- void setVoucherData(com.gov.nha.bis.erupi.voucher.req.VoucherData) 

    /**
     * Method unmarshalVoucherReq
     * 
     * 
     * 
     * @param reader
     * @return Object
     */
    public static java.lang.Object unmarshalVoucherReq(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.gov.nha.bis.erupi.voucher.req.VoucherReq) Unmarshaller.unmarshal(com.gov.nha.bis.erupi.voucher.req.VoucherReq.class, reader);
    } //-- java.lang.Object unmarshalVoucherReq(java.io.Reader) 

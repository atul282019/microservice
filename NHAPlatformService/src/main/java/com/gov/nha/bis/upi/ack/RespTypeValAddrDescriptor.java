...
/**
 * Class RespTypeValAddrDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RespTypeValAddrDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RespTypeValAddrDescriptor() 
     {
        super();
        nsURI = "http://npci.org/upi/schema/";
        xmlName = "respTypeValAddr";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RespTypeValAddr target = (RespTypeValAddr) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _maskName
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_maskName", "maskName", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    RespTypeValAddr target = (RespTypeValAddr) object;
                    target.setMaskName( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
        //-- _pType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.gov.nha.bis.upi.ack.types.RespPType.class, "_pType", "pType", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                RespTypeValAddr target = (RespTypeValAddr) object;
                return target.getPType();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    RespTypeValAddr target = (RespTypeValAddr) object;
                    target.setPType( (com.gov.nha.bis.upi.ack.types.RespPType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(com.gov.nha.bis.upi.ack.types.RespPType.class, handler);
        desc.setImmutable(true);
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        
        //-- validation code for: _pType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        ...
        desc.setValidator(fieldValidator);
        //-- _featureSupported
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.gov.nha.bis.upi.ack.FeatureSupported.class, "_featureSupported", "FeatureSupported", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                RespTypeValAddr target = (RespTypeValAddr) object;
                return target.getFeatureSupported();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    RespTypeValAddr target = (RespTypeValAddr) object;
                    target.setFeatureSupported( (com.gov.nha.bis.upi.ack.FeatureSupported) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.gov.nha.bis.upi.ack.FeatureSupported();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        //-- validation code for: _featureSupported
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        ...
        desc.setValidator(fieldValidator);
    } //-- com.gov.nha.bis.upi.ack.RespTypeValAddrDescriptor()
    ...
    {
        return com.gov.nha.bis.upi.ack.RespTypeValAddr.class;

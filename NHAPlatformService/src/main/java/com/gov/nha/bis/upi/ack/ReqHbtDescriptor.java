...
/**
 * Class ReqHbtDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ReqHbtDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReqHbtDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _hbtMsg
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.gov.nha.bis.upi.ack.HbtMsg.class, "_hbtMsg", "HbtMsg", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ReqHbt target = (ReqHbt) object;
                return target.getHbtMsg();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReqHbt target = (ReqHbt) object;
                    target.setHbtMsg( (com.gov.nha.bis.upi.ack.HbtMsg) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.gov.nha.bis.upi.ack.HbtMsg();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        //-- validation code for: _hbtMsg
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- com.gov.nha.bis.upi.ack.ReqHbtDescriptor()
    ...
    {
        return com.gov.nha.bis.upi.ack.ReqHbt.class;

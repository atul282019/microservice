...
public class BisDigitalSignatureServiceImpl implements BisDigitalSignatureService {
	static {
		Security.addProvider((Provider)new BouncyCastleProvider());
	}

	private static Log logger = LogFactory.getLog(BisDigitalSignatureServiceImpl.class);
	...
	public BisDigitalSignatureServiceImpl(String keyStoreFile, char[] keyStorePassword, String keyAlias) throws BisException {
		this(keyStoreFile, keyStorePassword, keyAlias, null, null);
	}

	public BisDigitalSignatureServiceImpl(String keyStoreFile, char[] keyStorePassword, String keyAlias, String trustStore, char[] trustStorePassword) throws BisException {
	...
	public BisDigitalSignatureServiceImpl(char[] keyStorePassword) throws BisException {
		this.keyStorePassword = keyStorePassword;
	}
	...
	public BisDigitalSignatureServiceImpl() {}
}

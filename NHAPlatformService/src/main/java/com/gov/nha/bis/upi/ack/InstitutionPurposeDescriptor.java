...
/**
 * Class InstitutionPurposeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class InstitutionPurposeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InstitutionPurposeDescriptor() 
     {
        super();
        nsURI = "http://npci.org/upi/schema/";
        xmlName = "institutionPurpose";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                InstitutionPurpose target = (InstitutionPurpose) object;
    ...
    } //-- com.gov.nha.bis.upi.ack.InstitutionPurposeDescriptor()
    ...
    {
        return com.gov.nha.bis.upi.ack.InstitutionPurpose.class;
